...
AutRelChecker <- function(x, y, s.column = 1) {
  cat("### Automatic Reliability Checker for Nominal Data - Felipe Martins ###\n")
  cat("### Version 1.0b - Revised and Functional, Source comments refer to line(s) above ###\n")
  cat("### Code Revision F - https://github.com/felmartins/AutRelChecker for updated version and changelog ###\n\n")
  Sys.sleep(4)
